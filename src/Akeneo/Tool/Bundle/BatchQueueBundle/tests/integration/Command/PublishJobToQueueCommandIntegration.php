...
class PublishJobToQueueCommandIntegration extends TestCase
{
    ...
    public function testPushJobExecutionIntoQueue()
    {
        ...
        $this->assertEquals('{"env":"test_database"}', $jobExecutionMessage['options']);
    ...
    public function testPushJobExecutionWithNoLog()
    {
        ...
        $this->assertEquals('{"env":"test_database","no-log":true}', $jobExecutionMessage['options']);
    }
    ...
    public function testLaunchJobWithValidEmail()
    {
        ...
        $this->assertEquals('{"env":"test_database","email":"ziggy@akeneo.com"}', $jobExecutionMessage['options']);
    }
